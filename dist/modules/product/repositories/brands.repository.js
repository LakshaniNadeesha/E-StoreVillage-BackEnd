...
let BrandsRepository = class BrandsRepository extends base_repository_1.BaseRepository {
    constructor(repo) {
        super(repo);
        this.repo = repo;
    }
};
BrandsRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(entities_1.Brands)),
